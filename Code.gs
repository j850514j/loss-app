...
function doPost(e) {
  try {
    ...
    var promptText =
      ...
      '  "sugar_g": 估計「添加糖」公克數（可以有小數）,\n' +
      '  "note": "一句話備註，例如份量估計或含糖飲料提醒（可留空字串）"\n' +
      "}\n" +
      "sugar_g 只計算額外添加的精製糖，例如手搖飲、甜點、含糖醬料、加工食品裡加的糖。\n" +
      "如果是新鮮水果、原味無加糖乳製品、原味堅果這類「天然含糖但沒有額外加糖」的食物，" +
      "sugar_g 請填 0（可以在 note 裡簡短提醒這是天然糖分，例如「天然果糖，未列入添加糖統計」）。\n" +
